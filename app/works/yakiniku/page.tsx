      ...
      <div className="max-w-2xl mx-auto px-6 py-24">
        ...
        <div className="space-y-10">
          ...
          <div>
            ...
            <p className="text-gray-700 leading-relaxed">「炎」と「肉」の世界観を表現するため、黒を基調とした背景に白を基本の文字色とし、要所にゴールドのアクセントを効かせて高級感を演出。予約・問い合わせなどのCTAには視認性の高いオレンジ系を使い、行動喚起を明確にした。高級感と迫力を両立させ、「ハレの日に行きたい店」という印象を狙った。メニュー・こだわり・アクセスの3点を明確に構成し、来店判断に必要な情報をすべてワンページに収めた。WordPress版での実装も検討・提案可能。</p>
          </div>
        </div>
